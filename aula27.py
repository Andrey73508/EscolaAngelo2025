...
#  1. Crie duas variáveis do tipo string, uma contendo “Olá” e outra contendo “Mundo”. Concaten eas e imprima o resultado.
string1 = "Olá"
string2 = "mundo"
...
string = input("Digite uma string com espaços no inicio e no final:")
print(string)
print(string.strip() + "!")
