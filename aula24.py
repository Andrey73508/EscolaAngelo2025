...
maior_numero = lista[0] # inicializa o primeiro da lista
...
# Imprima os tres primeiros elementos da lista ordenada
print("Os tres maiores numeros da lista são:", lista_ordenada[:3])
